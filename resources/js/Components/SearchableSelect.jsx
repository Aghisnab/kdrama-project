...
export default function SearchableSelect({ value, onChange, placeholder = 'Cari...', url, initialLabel }) {
    ...
    // Update label jika initialLabel berubah (misal dari props setelah load)
    useEffect(() => {
        if (initialLabel) {
                    ...
                    <div className="max-h-60 overflow-y-auto">
                        ...
                        {options.map((opt) => (
                            <div
                                key={opt.kdrama_id}
                                onClick={() => {
                                    onChange(opt.kdrama_id);
                                    setSelectedLabel(opt.kdrama_name);
                                    setOpen(false);
                                    setSearch('');
                                }}
